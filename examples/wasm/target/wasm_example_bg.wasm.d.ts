...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1823f6c7f8435826(a: number, b: number): void;
export function closure1206_externref_shim(a: number, b: number, c: number): void;
export function closure1211_externref_shim(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h791e80d4b4ccc27c(a: number, b: number): void;
export function closure61124_externref_shim(a: number, b: number, c: number): void;
export function closure70722_externref_shim(a: number, b: number, c: number): void;
